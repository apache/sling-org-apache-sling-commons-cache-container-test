...
# Apache Sling OSGi PAX Exam support library (deprecated)

This module is **obsolete**.

For reference or potential bugfix releases use branch [maintenance](https://github.com/apache/sling-org-apache-sling-commons-cache-api/tree/maintenance).